...
CTkButton(master=sidebar_frame, image=package_img, text="Purchase", fg_color="#fff", font=("Arial Bold", 14), text_color="#2A8C55", hover_color="#eee", anchor="w").pack(anchor="center", ipady=5, pady=(16, 0))
# ----------------------------------------------------------------
